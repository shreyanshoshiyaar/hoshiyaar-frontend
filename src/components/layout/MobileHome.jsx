      ...
      <div className="relative z-10 w-full flex flex-col px-4 pt-4">
        ...
        <div className="relative w-full min-h-[140px] mt-2 mb-4 flex items-center">
          <div className="relative z-10 w-[65%] pl-2">
            <h1 className="text-[26px] sm:text-[30px] font-black text-gray-900 leading-[0.95] tracking-tighter">
        ...
        <div className="grid grid-cols-12 gap-2 mb-3">
          ...
          <div className="col-span-7 bg-[#3B82F6] rounded-[32px] p-1 overflow-hidden relative shadow-md flex flex-col h-[260px] border border-blue-400">
            <div className="flex justify-center items-center py-2.5 text-white text-[14px] font-black tracking-widest uppercase">
            ...
            <div className="bg-white rounded-[28px] p-4 flex-1 flex flex-col items-center justify-center relative shadow-inner">
              ...
              <div className="flex flex-col items-center opacity-10">
                ...
                <div className="text-[12px] font-black uppercase tracking-widest text-blue-900">Next Mission Loading...</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-5 flex flex-col gap-3 h-[260px]">
            ...
            <div className="bg-[#F9F8FF] rounded-[32px] p-2 shadow-sm border border-[#E9D8FF] flex-1 flex flex-col items-center justify-center relative">
              ...
              <p className="text-[#4A5568] font-bold text-center text-[12px] leading-tight mb-1">
                Fresh mysteries <br />every
              </p>

              <div className="flex items-center gap-1 text-[#8B5CF6] font-black text-sm">
                <span className="opacity-50 text-base">≽</span> Tues & Fri <span className="opacity-50 text-base">≼</span>
              </div>
            </div>
            ...
            <div className="bg-[#EBF5FF] rounded-[24px] p-2 shadow-sm border border-[#D6E4FF] flex-1 flex flex-col items-center justify-center">
              <div className="flex items-center gap-2 mb-2 bg-white/50 px-3 py-1 rounded-full border border-white/40 shadow-sm">
                <h3 className="text-[#2C4A86] font-black text-[11px] whitespace-nowrap">Stay Connected</h3>
        ...
        <div className="w-full bg-[#F8FAFF] rounded-[32px] p-4 pt-5 pb-6 mb-4 shadow-inner border border-white/40 relative overflow-hidden">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-[22px] font-black text-gray-800 tracking-tight">Weekly Leaderboard</h2>
            <span className="text-yellow-400 text-[18px]">⭐</span>
          </div>
          ...
          <div className={`flex gap-3 w-full justify-center transition-all duration-500 ${!hasSchool ? 'blur-md grayscale opacity-50 select-none' : ''}`}>
            {lbItems.length > 0 ? (
              lbItems.map((item, idx) => (
                ...
                >
                  {/* Rank Badge */}
                  <div className={`absolute -top-2 -left-2 w-8 h-8 rounded-full text-white font-black flex items-center justify-center text-[16px] shadow-lg ${item.isMe ? 'bg-[#2563EB]' : 'bg-[#7C3AED]'
                    }`}>
                    {item.rank}
                  </div>

                  <div className={`font-black text-[18px] truncate w-full text-center mb-1.5 ${item.isMe ? 'text-[#1E40AF]' : 'text-gray-900'
                    }`}>
                  ...
                  <div className="flex items-center gap-1 bg-white rounded-full px-3 py-1 shadow-[inset_0_1px_3px_rgba(0,0,0,0.06)] border border-gray-50">
                    ...
                    <span className="text-[16px] font-black text-gray-700">{item.totalPoints || 0}</span>
                  </div>
                </div>
              ))
            ) : (
              <div className="flex flex-col items-center py-6 opacity-40">
                <span className="text-sm font-black text-blue-900 uppercase">No Rankings yet</span>
              </div>
            )}
          </div>
