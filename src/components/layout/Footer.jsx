...
const FooterLogo = "https://res.cloudinary.com/w7rytq0k/image/upload/v1785322514/img-to-link/bihseec7aigbmau4amnd.png";
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-10">
                    ...
                    <div className="flex flex-col space-y-4 lg:max-w-xs">
                        ...
                        <div className="flex gap-3 pt-2">
                            {/* Instagram */}
                            <a href="https://www.instagram.com/hoshiyaar_club/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-500 text-white hover:scale-110 transition-transform">
                            ...
                            {/* YouTube */}
                            <a href="https://www.youtube.com/@Hoshi-yaar/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center bg-[#ef4444] text-white hover:scale-110 transition-transform">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
                            </a>
                            {/* Facebook */}
                            <a href="https://www.facebook.com/people/HoshiYaar/61589159352632/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center bg-[#1877f2] text-white hover:scale-110 transition-transform">
