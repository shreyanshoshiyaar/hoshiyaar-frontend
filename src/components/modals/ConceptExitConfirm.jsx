...
const ExitConfirmCard = ({ onQuit, onContinue }) => (
  <div className="w-full max-w-md bg-white border-2 border-blue-200 rounded-2xl p-4 shadow-[0_8px_0_0_rgba(0,0,0,0.10)]">
    <div className="flex items-center gap-4">
      <img src="https://res.cloudinary.com/w7rytq0k/image/upload/v1785322552/img-to-link/gckzxx2cnidtzd3ylrto.webp" alt="Bye" className="w-16 h-16 sm:w-20 sm:h-20 object-contain select-none" />
